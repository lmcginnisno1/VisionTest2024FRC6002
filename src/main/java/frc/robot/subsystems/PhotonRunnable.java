...
import static frc.robot.Constants.CameraConstants.APRILTAG_AMBIGUITY_THRESHOLD;
    ...
    if (photonPoseEstimator != null && photonCamera != null) {
      ...
      if (photonResults.hasTargets()
        ...
        photonPoseEstimator.update(photonResults).ifPresent(estimatedRobotPose -> {
          ...
          if (estimatedPose.getX() > 0.0 && estimatedPose.getX() <= 16.4846
              && estimatedPose.getY() > 0.0 && estimatedPose.getY() <= 8.1026) {
